...
<div class="ebi-content">
    ...
    <div class="grid_24 ">
        <h2>Search results for <span class="searchterm"><c:out value='${q}'/></span></h2>
                        ...
                        <c:when test="${maxpage>1}">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    ...
                                    <a class="page" href="./query${url}<mytag:today name="species" value="${species}"/><mytag:today name="types" value="${types}"/><mytag:today name="compartments" value="${compartments}"/><mytag:today name="keywords" value="${keywords}"/>&amp;cluster=${cluster}&amp;page=1">first</a>
                                </c:otherwise>
                            </c:choose>
                                ...
                                <c:if test="${val > page-3 && val < page+3}">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <a class="page" href="./query${url}<mytag:today name="species" value="${species}"/><mytag:today name="types" value="${types}"/><mytag:today name="compartments" value="${compartments}"/><mytag:today name="keywords" value="${keywords}"/>&amp;cluster=${cluster}&amp;page=${val}">${val}</a>
                                        </c:otherwise>
                                    </c:choose>
                                </c:if>
                            </c:forEach>
                            <c:choose>
                                ...
                                <c:otherwise>
                                    ...
                                    <a class="page" href="./query${url}<mytag:today name="species" value="${species}"/><mytag:today name="types" value="${types}"/><mytag:today name="compartments" value="${compartments}"/><mytag:today name="keywords" value="${keywords}"/>&amp;cluster=${cluster}&amp;page=${maxpage}">last</a>
                                </c:otherwise>
                            </c:choose>
                        </c:when>
                    </c:choose>
